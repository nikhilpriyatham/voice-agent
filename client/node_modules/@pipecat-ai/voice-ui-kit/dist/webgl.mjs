...
import { memo, forwardRef, useRef, useCallback, useImperativeHandle, useEffect } from "react";
import { usePipecatClientTransportState, usePipecatClientMediaTrack } from "@pipecat-ai/client-react";
/**
 * @license
...
const Plasma = memo(
  forwardRef(
    ({
      ...
      const smoothedAudioRef = useRef(null);
