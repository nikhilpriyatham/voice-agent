...
const clientReact = require("@pipecat-ai/client-react");
const ReactDOM = require("react-dom");
const Metrics = require("./Metrics-DQ03Hqze.cjs");
const clientJs = require("@pipecat-ai/client-js");
const Daily = require("@daily-co/daily-js");
const dailyTransport = require("@pipecat-ai/daily-transport");
...
function createSlot(ownerName) {
  ...
  const Slot2 = React__namespace.forwardRef((props2, forwardedRef) => {
...
function createSlotClone(ownerName) {
  const SlotClone = React__namespace.forwardRef((props2, forwardedRef) => {
    const { children, ...slotProps } = props2;
    if (React__namespace.isValidElement(children)) {
      ...
      return React__namespace.cloneElement(children, props22);
    }
...
var FocusScope = React__namespace.forwardRef((props2, forwardedRef) => {
  const {
    loop = false,
    trapped = false,
...
var NAME$1 = "Arrow";
var Arrow$1 = React__namespace.forwardRef((props2, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Primitive.svg,
    {
      ...
      children: props2.asChild ? children : /* @__PURE__ */ jsxRuntime.jsx("polygon", { points: "0,0 30,0 15,10" })
    }
  );
});
...
var PopperArrow = React__namespace.forwardRef(function PopperArrow2(props2, forwardedRef) {
...
var Portal$4 = React__namespace.forwardRef((props2, forwardedRef) => {
  var _a;
...
var RemoveScroll = React__namespace.forwardRef(function(props2, parentRef) {
...
function RemoveScrollSideCar(props2) {
  ...
  var lastProps = React__namespace.useRef(props2);
  React__namespace.useEffect(function() {
  ...
  return React__namespace.createElement(
    ...
    removeScrollBar ? React__namespace.createElement(RemoveScrollBar, { noRelative: props2.noRelative, gapMode: props2.gapMode }) : null
  );
}
...
var ReactRemoveScroll = React__namespace.forwardRef(function(props2, ref) {
  return React__namespace.createElement(RemoveScroll, __assign({}, props2, { ref, sideCar: SideCar }));
});
...
var SelectPortal = (props2) => {
  return /* @__PURE__ */ jsxRuntime.jsx(Portal$4, { asChild: true, ...props2 });
};
  ...
  (props2, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM__namespace.createPortal(
        /* @__PURE__ */ jsxRuntime.jsx(SelectContentProvider, { scope: props2.__scopeSelect, children: /* @__PURE__ */ jsxRuntime.jsx(Collection$2.Slot, { scope: props2.__scopeSelect, children: /* @__PURE__ */ jsxRuntime.jsx("div", { children: props2.children }) }) }),
        frag
      ) : null;
    }
    return /* @__PURE__ */ jsxRuntime.jsx(SelectContentImpl, { ...props2, ref: forwardedRef });
  }
);
...
var SelectItemAlignedPosition = React__namespace.forwardRef((props2, forwardedRef) => {
...
var SelectPopperPosition = React__namespace.forwardRef((props2, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectScrollUpButton$1 = React__namespace.forwardRef((props2, forwardedRef) => {
...
var SelectScrollDownButton$1 = React__namespace.forwardRef((props2, forwardedRef) => {
...
var SelectScrollButtonImpl = React__namespace.forwardRef((props2, forwardedRef) => {
...
const createLucideIcon = (iconName, iconNode) => {
  const Component = React.forwardRef(
    ({ className, ...props2 }, ref) => React.createElement(Icon, {
      ref,
      iconNode,
...
function Select({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Root2$3, { "data-slot": "select", ...props2 });
}
function SelectGroup({
  ...props2
}) {
  return /* @__PURE__ */ jsxRuntime.jsx(Group$1, { "data-slot": "select-group", ...props2 });
}
function SelectValue({
  ...props2
}) {
  return /* @__PURE__ */ jsxRuntime.jsx(Value, { "data-slot": "select-value", ...props2 });
}
function SelectTrigger({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    Trigger$4,
    {
      ...
      "data-size": size2,
      className: Metrics.cn(
        selectTriggerVariants({ size: size2 }),
        "vkui:truncate",
        className
      ),
      ...props2,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:truncate vkui:flex-1 vkui:min-w-0", children }),
        /* @__PURE__ */ jsxRuntime.jsx(Icon$1, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(SelectChevronIcon, { className: "vkui:opacity-50 vkui:flex-none" }) })
      ]
    }
  );
}
function SelectGuide({ className, ...props2 }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "span",
    {
      ...
      className: Metrics.cn("vkui:text-subtle vkui:font-sans", className),
      ...props2
    }
  );
}
function SelectContent({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Portal$3, { container: getPipecatUIContainer(), children: /* @__PURE__ */ jsxRuntime.jsxs(
    Content2$4,
    {
...
function SelectItem({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    Item$1,
    {
      ...
      ...props2,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:absolute vkui:right-2 vkui:flex vkui:size-3.5 vkui:items-center vkui:justify-center", children: /* @__PURE__ */ jsxRuntime.jsx(ItemIndicator$1, { children: /* @__PURE__ */ jsxRuntime.jsx(CheckIcon, { className: "size-4" }) }) }),
...
function SelectScrollDownButton({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ScrollDownButton,
    {
      ...
      ...props2,
      children: /* @__PURE__ */ jsxRuntime.jsx(ChevronDownIcon, { className: "size-4" })
    }
  );
}
const AudioOutput = ({ className }) => {
  const { availableSpeakers, selectedSpeaker, updateSpeaker } = clientReact.usePipecatClientMediaDevices();
  const handleDeviceChange = (deviceId) => {
    updateSpeaker(deviceId);
  };
  const id = React.useId();
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:flex vkui:items-center vkui:gap-4", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "label",
      {
        htmlFor: id,
      ...
      Select,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ...
            {
              id,
              className: Metrics.cn("vkui:border-none vkui:w-full", className),
              children: /* @__PURE__ */ jsxRuntime.jsx(SelectValue, { placeholder: "Select a speaker" })
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(SelectContent, { align: "end", children: availableSpeakers.map((device) => /* @__PURE__ */ jsxRuntime.jsx(
            SelectItem,
            {
...
const DataList = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "dl",
    {
      ...
      children: Object.entries(data).map(([key, value]) => /* @__PURE__ */ jsxRuntime.jsxs(React.Fragment, { children: [
        /* @__PURE__ */ jsxRuntime.jsx("dt", { className: Metrics.cn("vkui:text-muted-foreground", classNames.key), children: key }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "dd",
          {
            className: Metrics.cn(
...
const ClientStatus = ({
  ...
  const transportState = clientReact.usePipecatClientTransportState();
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotReady, () => {
    if (noAgentState) return;
    setIsBotConnected(true);
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.Disconnected, () => {
    if (noAgentState) return;
    setIsBotConnected(false);
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotDisconnected, () => {
    if (noAgentState) return;
    setIsBotConnected(false);
  });
  ...
  const data = {};
  if (!noClientState) {
    data["Client"] = /* @__PURE__ */ jsxRuntime.jsx(
      "span",
      {
        className: Metrics.cn(
          "vkui:uppercase",
  ...
  if (!noAgentState) {
    data["Agent"] = isBotConnected ? /* @__PURE__ */ jsxRuntime.jsx(
      "span",
      {
        className: Metrics.cn(
    ...
    ) : agentConnecting ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: Metrics.cn("vkui:uppercase", classNames.agentValue), children: "Connecting..." }) : "---";
  }
  return /* @__PURE__ */ jsxRuntime.jsx(DataList, { classNames, data });
};
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntime.jsxs(
      Comp,
      {
        ...
        disabled: true,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(LoaderIcon, { className: "vkui:animate-spin" }),
          props2.children
        ]
      }
    );
...
const ConnectButtonComponent = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Button,
    {
      ...
      className: Metrics.cn(className, passedClassName),
      children
    }
  );
};
const ConnectButton = React.memo((props2) => {
  const transportState = clientReact.usePipecatClientTransportState();
  return /* @__PURE__ */ jsxRuntime.jsx(ConnectButtonComponent, { transportState, ...props2 });
});
...
function CardTitle({ className, ...props2 }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      className: Metrics.cn("vkui:leading-none vkui:font-semibold", className),
      ...props2
    }
  );
}
function CardDescription({ className, ...props2 }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      className: Metrics.cn("vkui:text-muted-foreground vkui:text-sm", className),
      ...props2
    }
  );
}
...
function CardContent({ className, ...props2 }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      className: Metrics.cn("vkui:gap-2 vkui:md:gap-3 vkui:p-2 vkui:md:p-3", className),
      ...props2
    }
  );
}
...
var RovingFocusGroup = React__namespace.forwardRef(
  (props2, forwardedRef) => {
    return /* @__PURE__ */ jsxRuntime.jsx(Collection$1.Provider, { scope: props2.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsxRuntime.jsx(Collection$1.Slot, { scope: props2.__scopeRovingFocusGroup, children: /* @__PURE__ */ jsxRuntime.jsx(RovingFocusGroupImpl, { ...props2, ref: forwardedRef }) }) });
  }
);
RovingFocusGroup.displayName = GROUP_NAME$2;
var RovingFocusGroupImpl = React__namespace.forwardRef((props2, forwardedRef) => {
  const {
...
var MenuPortal = (props2) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider$2, { scope: __scopeMenu, forceMount, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$4, { asChild: true, container, children }) }) });
};
...
var MenuContent = React__namespace.forwardRef(
  (props2, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(Collection.Provider, { scope: props2.__scopeMenu, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Collection.Slot, { scope: props2.__scopeMenu, children: rootContext.modal ? /* @__PURE__ */ jsxRuntime.jsx(MenuRootContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsxRuntime.jsx(MenuRootContentNonModal, { ...contentProps, ref: forwardedRef }) }) }) });
  }
);
...
var MenuRootContentNonModal = React__namespace.forwardRef((props2, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME$4, props2.__scopeMenu);
  return /* @__PURE__ */ jsxRuntime.jsx(
    MenuContentImpl,
    {
...
var MenuCheckboxItem = React__namespace.forwardRef(
  (props2, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(ItemIndicatorProvider, { scope: props2.__scopeMenu, checked, children: /* @__PURE__ */ jsxRuntime.jsx(
      MenuItem,
      {
...
var MenuRadioGroup = React__namespace.forwardRef(
  (props2, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(RadioGroupProvider, { scope: props2.__scopeMenu, value, onValueChange: handleValueChange, children: /* @__PURE__ */ jsxRuntime.jsx(MenuGroup, { ...groupProps, ref: forwardedRef }) });
  }
);
...
var MenuSubContent = React__namespace.forwardRef(
  (props2, forwardedRef) => {
    ...
    const ref = React__namespace.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    return /* @__PURE__ */ jsxRuntime.jsx(Collection.Provider, { scope: props2.__scopeMenu, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Collection.Slot, { scope: props2.__scopeMenu, children: /* @__PURE__ */ jsxRuntime.jsx(
      MenuContentImpl,
      {
...
var DropdownMenuCheckboxItem$1 = React__namespace.forwardRef((props2, forwardedRef) => {
...
var DropdownMenuRadioGroup$1 = React__namespace.forwardRef((props2, forwardedRef) => {
...
var DropdownMenuRadioItem$1 = React__namespace.forwardRef((props2, forwardedRef) => {
...
var DropdownMenuItemIndicator = React__namespace.forwardRef((props2, forwardedRef) => {
...
var DropdownMenuSeparator$1 = React__namespace.forwardRef((props2, forwardedRef) => {
...
var DropdownMenuSubTrigger$1 = React__namespace.forwardRef((props2, forwardedRef) => {
...
var DropdownMenuSubContent$1 = React__namespace.forwardRef((props2, forwardedRef) => {
...
function DropdownMenu({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Root2$2, { "data-slot": "dropdown-menu", ...props2 });
}
...
function DropdownMenuGroup({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Group2, { "data-slot": "dropdown-menu-group", ...props2 });
}
...
function DropdownMenuCheckboxItem({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    CheckboxItem2,
    {
      ...
      ...props2,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:pointer-events-none vkui:absolute vkui:left-2 vkui:flex size-3.5 vkui:items-center vkui:justify-center", children: /* @__PURE__ */ jsxRuntime.jsx(ItemIndicator2, { children: /* @__PURE__ */ jsxRuntime.jsx(CheckIcon, {}) }) }),
        children
      ]
    }
  );
...
function DropdownMenuRadioItem({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    RadioItem2,
    {
      ...
      ...props2,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:pointer-events-none vkui:absolute vkui:left-2 vkui:flex vkui:size-3.5 vkui:items-center vkui:justify-center", children: /* @__PURE__ */ jsxRuntime.jsx(ItemIndicator2, { children: /* @__PURE__ */ jsxRuntime.jsx(CircleIcon, { className: "size-2 vkui:fill-current" }) }) }),
        children
      ]
    }
  );
...
function DropdownMenuSeparator({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Separator2,
    {
      ...
      className: Metrics.cn("vkui:bg-border vkui:-mx-1 vkui:my-1 vkui:h-px", className),
      ...props2
    }
  );
}
...
function DropdownMenuSub({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Sub2, { "data-slot": "dropdown-menu-sub", ...props2 });
}
function DropdownMenuSubTrigger({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    SubTrigger2,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsxRuntime.jsx(ChevronRightIcon, { className: "vkui:ml-auto vkui:size-4" })
      ]
    }
  );
}
...
const ErrorCard = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    Card,
    {
      className: Metrics.cn("vkui:shadow-long vkui:min-w-md vkui:gap-0", className),
      destructive: true,
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(CardHeader, { className: "vkui:font-semibold vkui:flex vkui:flex-row vkui:items-center", children: [
          /* @__PURE__ */ jsxRuntime.jsx(InfoIcon, { size: 24 }),
          title
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntime.jsx("p", { className: "vkui:text-sm vkui:text-balanced", children: error }) })
      ]
    }
  );
};
...
function Input({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "input",
    {
      type,
      "data-slot": "input",
      className: Metrics.cn(inputVariants({ size: size2, className })),
      ...props2
    }
  );
}
function LayoutSection({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("section", { "data-section": sectionKey, className: Metrics.cn(className), ...props2 });
}
const LoaderSpinner = ({ size: size2 = 32 }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(LoaderIcon, { className: "vkui:animate-spin vkui:opacity-50", size: size2 });
};
...
function PanelHeader({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      className: Metrics.cn(PanelHeaderVariants({ variant, className }), className),
      ...props2
    }
  );
}
function PanelTitle({ className, ...props2 }) {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      className: Metrics.cn("vkui:text-mono-upper", className),
      ...props2
    }
  );
}
...
var PopoverPortal = (props2) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider$1, { scope: __scopePopover, forceMount, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$4, { asChild: true, container, children }) }) });
};
...
function Popover({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Root2$1, { "data-slot": "popover", ...props2 });
}
function PopoverTrigger({
  ...props2
}) {
  return /* @__PURE__ */ jsxRuntime.jsx(Trigger$2, { "data-slot": "popover-trigger", ...props2 });
}
function PopoverContent({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Portal$1, { container: getPipecatUIContainer(), children: /* @__PURE__ */ jsxRuntime.jsx(
    Content2$1,
    {
...
function PopoverAnchor({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Anchor2, { "data-slot": "popover-anchor", ...props2 });
}
...
const Panel = React.forwardRef((props2, ref) => React.createElement(PanelWithForwardedRef, {
  ...props2,
  forwardedRef: ref
}));
...
function PanelGroupWithForwardedRef({
  ...
  const panelSizeBeforeCollapseRef = React.useRef(/* @__PURE__ */ new Map());
  ...
  const registerResizeHandle2 = React.useCallback((dragHandleId) => {
    let isRTL2 = false;
  ...
  const resizePanel2 = React.useCallback((panelData, unsafePanelSize) => {
    const {
      onLayout: onLayout2
    } = committedValuesRef.current;
    const {
...
const PanelGroup = React.forwardRef((props2, ref) => React.createElement(PanelGroupWithForwardedRef, {
  ...props2,
  forwardedRef: ref
}));
...
function ResizablePanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Panel, { "data-slot": "resizable-panel", ...props2 });
}
    ...
    PanelResizeHandle,
    {
      ...
      children: withHandle && /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(EllipsisVerticalIcon, { size: 16 })
        }
      )
    }
  );
...
function Tabs({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      "data-slot": "tabs",
      className: Metrics.cn("vkui:flex vkui:flex-col vkui:gap-2", className),
      ...props2
    }
  );
}
...
var TooltipTrigger$1 = React__namespace.forwardRef(
  (props2, forwardedRef) => {
    ...
    const handlePointerUp2 = React__namespace.useCallback(() => isPointerDownRef.current = false, []);
    React__namespace.useEffect(() => {
...
var TooltipPortal = (props2) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider, { scope: __scopeTooltip, forceMount, children: /* @__PURE__ */ jsxRuntime.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(Portal$4, { asChild: true, container, children }) }) });
};
...
var TooltipContentHoverable = React__namespace.forwardRef((props2, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME, props2.__scopeTooltip);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(TooltipContentImpl, { ...props2, ref: composedRefs });
});
...
function Tooltip({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntime.jsx(Root3, { "data-slot": "tooltip", ...props2 }) });
}
function TooltipTrigger({
  ...props2
}) {
  return /* @__PURE__ */ jsxRuntime.jsx(Trigger, { "data-slot": "tooltip-trigger", ...props2 });
}
function TooltipContent({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Portal, { container: getPipecatUIContainer(), children: /* @__PURE__ */ jsxRuntime.jsxs(
    Content2,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ jsxRuntime.jsx(Arrow2, { className: "vkui:bg-primary vkui:fill-primary vkui:z-50 vkui:size-2.5 vkui:translate-y-[calc(-50%_-_2px)] vkui:rotate-45 vkui:rounded-[2px]" })
      ]
    }
  ) });
}
const ControlBarDivider = ({
  className
}) => {
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
...
const ControlBar = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    Card,
    {
      ...
      ...props2,
      children: /* @__PURE__ */ jsxRuntime.jsx(CardContent, { className: "vkui:flex vkui:flex-row vkui:gap-4 vkui:p-4", children })
    }
  );
};
...
const useConversation = ({ onMessageAdded } = {}) => {
  const [messages, setMessages] = React.useState([]);
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.Connected, () => {
    setMessages([]);
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotLlmStarted, () => {
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotLlmText, (data) => {
    const now = /* @__PURE__ */ new Date();
    setMessages((prev) => {
      const lastBotMessageIndex = prev.findLastIndex(
        (msg) => msg.role === "assistant"
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotLlmStopped, () => {
    setMessages((prev) => {
      const lastBotMessageIndex = prev.findLastIndex(
        (msg) => msg.role === "assistant"
      );
  ...
  const userStoppedTimeout = React.useRef(void 0);
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.UserStartedSpeaking, () => {
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.UserTranscript, (data) => {
    const now = /* @__PURE__ */ new Date();
    setMessages((prev) => {
      const lastUserMessageIndex = prev.findLastIndex(
        (msg) => msg.role === "user"
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.UserStoppedSpeaking, () => {
    clearTimeout(userStoppedTimeout.current);
...
const Thinking = ({
  ...
  const [dots, setDots] = React.useState(initialDots);
  React.useEffect(() => {
    const i = setInterval(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("span", { className, "aria-label": ariaLabel, children: renderDots() });
};
const Conversation = ({
  classNames = {},
  noAutoscroll = false
  ...
  const isScrolledToBottom = React.useRef(true);
  const transportState = clientReact.usePipecatClientTransportState();
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            ...
            children: messages.map((message, index2) => /* @__PURE__ */ jsxRuntime.jsxs(React.Fragment, { children: [
              /* @__PURE__ */ jsxRuntime.jsx(
                "div",
                {
                  className: Metrics.cn(
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(
                "div",
                {
                  ...
                  children: [
                    message.content || /* @__PURE__ */ jsxRuntime.jsx(Thinking, { className: classNames.thinking }),
                    /* @__PURE__ */ jsxRuntime.jsx(
                      "div",
                      {
                        className: Metrics.cn(
  ...
  if (isConnecting) {
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:text-muted-foreground vkui:text-sm", children: "Connecting to agent..." })
      }
    );
  }
  if (!isConnected) {
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:text-center vkui:p-4", children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:text-muted-foreground vkui:mb-2", children: "Not connected to agent" }),
          /* @__PURE__ */ jsxRuntime.jsx("p", { className: "vkui:text-sm vkui:text-muted-foreground vkui:max-w-md", children: "Connect to an agent to see conversation messages in real-time." })
        ] })
      }
    );
  }
  return /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:text-muted-foreground vkui:text-sm", children: "Waiting for messages..." })
    }
  );
};
const CopyText = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:truncate vkui:min-w-0", children: text }),
        /* @__PURE__ */ jsxRuntime.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntime.jsxs(Tooltip, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(
            Button,
            {
              ...
              children: copied ? /* @__PURE__ */ jsxRuntime.jsx(CopyCheck, { size: iconSize }) : /* @__PURE__ */ jsxRuntime.jsx(Copy, { size: iconSize })
            }
          ) }),
          /* @__PURE__ */ jsxRuntime.jsx(TooltipContent, { children: copied ? "Copied!" : "Copy to clipboard" })
        ] }) })
      ]
    }
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M36.5624 22.75H44.9582V26H36.5624V22.75Z", fill: color }),
        /* @__PURE__ */ jsxRuntime.jsx("path", { d: "M0 22.75H8.39581V26H0V22.75Z", fill: color }),
        /* @__PURE__ */ jsxRuntime.jsx(
          "path",
          {
...
const SessionInfo = ({
  ...
  const client = clientReact.usePipecatClient();
  ...
  if (!noSessionId) {
    data["Session ID"] = sessionId ? /* @__PURE__ */ jsxRuntime.jsx(CopyText, { className: "vkui:justify-end", iconSize: 12, text: sessionId }) : "---";
  }
  if (!noParticipantId) {
    data["Participant ID"] = participantId ? /* @__PURE__ */ jsxRuntime.jsx(
      CopyText,
      {
...
const TranscriptOverlayPartComponent = ({ text }) => /* @__PURE__ */ jsxRuntime.jsx("span", { children: text });
const TranscriptOverlayComponent = ({
  children,
  className,
  size: size2 = "default",
  turnEnd
...
const TranscriptOverlay = ({
  ...
  const [turnEnd, setIsTurnEnd] = React.useState(false);
  const transportState = clientReact.usePipecatClientTransportState();
  clientReact.useRTVIClientEvent(
    clientJs.RTVIEvent.BotTtsText,
    React.useCallback(
      (event) => {
  ...
  clientReact.useRTVIClientEvent(
    clientJs.RTVIEvent.BotStoppedSpeaking,
    React.useCallback(() => {
      if (participant === "local") {
        return;
      }
  ...
  clientReact.useRTVIClientEvent(
    clientJs.RTVIEvent.BotTtsStopped,
    React.useCallback(() => {
      if (participant === "local") {
        return;
      }
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    TranscriptOverlayComponent,
    {
      ...
      turnEnd,
      className,
      children: /* @__PURE__ */ jsxRuntime.jsx(TranscriptOverlayPartComponent, { text: transcript.join(" ") })
    }
  );
};
const VoiceVisualizer = React.memo(
  ({
    ...
    const resolvedBarColorRef = React.useRef("black");
    React.useEffect(() => {
    ...
    const track = clientReact.usePipecatClientMediaTrack(
      "audio",
      participantType
    );
    React.useEffect(() => {
      ...
      canvasCtx.lineCap = barLineCap;
      const bands = Array.from({ length: barCount2 }, (_, i) => {
...
const DeviceDropDown = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(DropdownMenu, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      ...
      {
        align: "end",
        className: Metrics.cn(classNames == null ? void 0 : classNames.dropdownMenuContent),
        children: [
          !noMenuLabel && /* @__PURE__ */ jsxRuntime.jsx(DropdownMenuLabel, { children: menuLabel }),
          !noMenuSeparator && /* @__PURE__ */ jsxRuntime.jsx(DropdownMenuSeparator, {}),
          availableDevices == null ? void 0 : availableDevices.map((device) => /* @__PURE__ */ jsxRuntime.jsx(
            DropdownMenuCheckboxItem,
            {
              ...
              className: Metrics.cn(classNames == null ? void 0 : classNames.dropdownMenuCheckboxItem),
...
const UserAudioComponent = ({
  ...
  if (noAudio || (buttonProps == null ? void 0 : buttonProps.isLoading)) {
    return /* @__PURE__ */ jsxRuntime.jsx(
      Button,
      {
        ...
        children: !(buttonProps == null ? void 0 : buttonProps.isLoading) && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(MicOffIcon, {}),
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:flex-1", children: noAudioText })
        ] })
      }
    );
  }
  ...
  const button = /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsxs(
      Button,
      {
        onClick,
        className: Metrics.cn(btnClasses, classNames.button),
        variant,
        state: buttonState,
        size: size2,
        ...buttonProps,
        children: [
          isMicEnabled ? /* @__PURE__ */ jsxRuntime.jsx(MicIcon, {}) : /* @__PURE__ */ jsxRuntime.jsx(MicOffIcon, {}),
          !noVisualizer && /* @__PURE__ */ jsxRuntime.jsx(
            VoiceVisualizer,
            {
    ...
    !noDevicePicker && /* @__PURE__ */ jsxRuntime.jsx(
      DeviceDropDown,
      {
...
const UserAudioControl = (props2) => {
  const client = clientReact.usePipecatClient();
  const { availableMics, selectedMic, updateMic } = clientReact.usePipecatClientMediaDevices();
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(clientReact.PipecatClientMicToggle, { children: ({ isMicEnabled, onClick }) => /* @__PURE__ */ jsxRuntime.jsx(
    UserAudioComponent,
    {
      noAudio: !hasAudio,
      onClick,
...
const UserVideoComponent = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        !noVideo && /* @__PURE__ */ jsxRuntime.jsx(
          clientReact.PipecatClientVideo,
          {
            className: Metrics.cn(
              "vkui:rounded-xl",
              {
        ...
        (!isCamEnabled || noVideo) && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            className: Metrics.cn(
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:absolute vkui:bottom-2 vkui:left-2", children: /* @__PURE__ */ jsxRuntime.jsxs(ButtonGroup, { className: Metrics.cn(classNames.buttongroup), children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            Button,
            {
              className: Metrics.cn(classNames.button),
              variant: "outline",
              onClick,
              ...buttonProps,
              children: isCamEnabled ? /* @__PURE__ */ jsxRuntime.jsx(VideoIcon, {}) : /* @__PURE__ */ jsxRuntime.jsx(VideoOffIcon, {})
            }
          ),
          !noDevicePicker && /* @__PURE__ */ jsxRuntime.jsx(
            DeviceDropDown,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(
                Button,
                {
                  className: Metrics.cn(classNames.dropdownMenuTrigger),
                  variant: "outline",
                  ...dropdownButtonProps,
...
const UserVideoControl = (props2) => {
  const { availableCams, selectedCam, updateCam } = clientReact.usePipecatClientMediaDevices();
  return /* @__PURE__ */ jsxRuntime.jsx(clientReact.PipecatClientCamToggle, { children: ({ isCamEnabled, onClick }) => /* @__PURE__ */ jsxRuntime.jsx(
    UserVideoComponent,
    {
      ...props2,
      isCamEnabled,
...
function ThemeProvider({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ThemeProviderContext.Provider, { ...props2, value, children });
}
const AudioClientHelper = ({
  connectParams,
  transportType,
  clientOptions,
  children
  ...
  React.useEffect(() => {
    ...
    switch (transportType) {
      case "smallwebrtc":
        transport = new smallWebrtcTransport.SmallWebRTCTransport();
        break;
      case "daily":
      default:
        transport = new dailyTransport.DailyTransport();
        break;
    }
    const pcClient = new clientJs.PipecatClient({
      enableCam: false,
      enableMic: true,
      transport,
      ...clientOptions
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntime.jsxs(clientReact.PipecatClientProvider, { client, children: [
    children({
      handleConnect,
      handleDisconnect,
      loading: false,
    ...
    /* @__PURE__ */ jsxRuntime.jsx(clientReact.PipecatClientAudio, {})
  ] }) });
};
const useTheme = () => {
...
function ThemeModeToggle() {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(DropdownMenu, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsxs(Button, { variant: "ghost", children: [
      /* @__PURE__ */ jsxRuntime.jsx(SunIcon, { className: "vkui:h-[1.2rem] vkui:w-[1.2rem] vkui:scale-100 vkui:rotate-0 vkui:transition-all vkui:dark:scale-0 vkui:dark:-rotate-90" }),
      /* @__PURE__ */ jsxRuntime.jsx(MoonIcon, { className: "vkui:absolute vkui:h-[1.2rem] vkui:w-[1.2rem] vkui:scale-0 vkui:rotate-90 vkui:transition-all vkui:dark:scale-100 vkui:dark:rotate-0" }),
      /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:sr-only", children: "Toggle theme" })
    ] }) }),
...
const BotAudioPanel = ({
  ...
  const track = clientReact.usePipecatClientMediaTrack("audio", "bot");
  const [maxHeight, setMaxHeight] = React.useState(48);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Panel$1, { className, children: [
    !collapsed && /* @__PURE__ */ jsxRuntime.jsx(PanelHeader, { children: /* @__PURE__ */ jsxRuntime.jsx(PanelTitle, { children: "Bot Audio" }) }),
    /* @__PURE__ */ jsxRuntime.jsx(PanelContent, { className: "vkui:overflow-hidden", children: /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ref: containerRef,
        className: "vkui:relative vkui:aspect-video vkui:flex vkui:max-h-full vkui:overflow-hidden",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:m-auto", children: /* @__PURE__ */ jsxRuntime.jsx(
            clientReact.VoiceVisualizer,
            {
              participantType: "bot",
              backgroundColor: "transparent",
              barColor: "#ad46ff",
          ...
          !track && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:absolute vkui:inset-0 vkui:flex vkui:gap-1 vkui:items-center vkui:justify-center", children: [
            /* @__PURE__ */ jsxRuntime.jsx(MicOffIcon, { size: 16 }),
            !collapsed && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:font-mono vkui:text-xs", children: "No audio" })
          ] })
        ]
      }
    ) })
...
const BotVideoPanel = ({
  ...
  const track = clientReact.usePipecatClientMediaTrack("video", "bot");
  return /* @__PURE__ */ jsxRuntime.jsxs(
    Panel$1,
    {
      className: Metrics.cn(className, {
        "vkui:border-none": collapsed
      }),
      children: [
        !collapsed && /* @__PURE__ */ jsxRuntime.jsx(PanelHeader, { children: /* @__PURE__ */ jsxRuntime.jsx(PanelTitle, { children: "Bot Video" }) }),
        /* @__PURE__ */ jsxRuntime.jsxs(
          PanelContent,
          {
            className: Metrics.cn("vkui:relative vkui:overflow-hidden", {
              "vkui:p-0!": collapsed
            }),
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(
              ...
              !track && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:absolute vkui:inset-0 vkui:flex vkui:gap-1 vkui:items-center vkui:justify-center", children: [
                /* @__PURE__ */ jsxRuntime.jsx(VideoOffIcon, { size: 16 }),
                !collapsed && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:font-mono vkui:text-xs", children: "No video" })
              ] })
            ]
          }
        )
...
const ConversationPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(Tabs, { className: "vkui:h-full", defaultValue, children: /* @__PURE__ */ jsxRuntime.jsxs(Panel$1, { className: "vkui:h-full vkui:max-sm:border-none", children: [
    /* @__PURE__ */ jsxRuntime.jsx(PanelHeader, { children: /* @__PURE__ */ jsxRuntime.jsxs(TabsList, { children: [
      !noConversation && /* @__PURE__ */ jsxRuntime.jsxs(
        TabsTrigger,
        {
          className: "vkui:text-mono-upper",
          value: "conversation",
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(MessagesSquareIcon, { size: 16 }),
            "Conversation"
          ]
        }
      ),
      !noMetrics && /* @__PURE__ */ jsxRuntime.jsxs(TabsTrigger, { className: "vkui:text-mono-upper", value: "metrics", children: [
        /* @__PURE__ */ jsxRuntime.jsx(LineChartIcon, { size: 16 }),
        "Metrics"
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(PanelContent, { className: "vkui:p-0! vkui:overflow-hidden vkui:h-full", children: [
      !noConversation && /* @__PURE__ */ jsxRuntime.jsx(
        TabsContent,
        {
          value: "conversation",
          className: "vkui:overflow-hidden vkui:h-full",
          children: /* @__PURE__ */ jsxRuntime.jsx(Conversation, {})
        }
      ),
      !noMetrics && /* @__PURE__ */ jsxRuntime.jsx(TabsContent, { value: "metrics", className: "vkui:h-full", children: /* @__PURE__ */ jsxRuntime.jsx(Metrics.Metrics, {}) })
    ] })
  ] }) });
};
const EventsPanel = ({ collapsed = false }) => {
  const client = clientReact.usePipecatClient();
  const [events, setEvents] = React.useState([]);
  const scrollRef = React.useRef(null);
  const isScrolledToBottom = React.useRef(true);
  const addEvent = React.useCallback((data) => {
  ...
  const transportState = clientReact.usePipecatClientTransportState();
  const lastTransportState = React.useRef("");
  React.useEffect(() => {
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotConnected, (participant) => {
    addEvent({
      event: clientJs.RTVIEvent.BotConnected,
      message: `Bot connected: ${participant.id}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotDisconnected, (participant) => {
    addEvent({
      event: clientJs.RTVIEvent.BotDisconnected,
      message: `Bot disconnected: ${participant.id}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotReady, (botData) => {
    addEvent({
      event: clientJs.RTVIEvent.BotReady,
      message: `Bot ready (v${botData.version}): ${JSON.stringify(botData.about ?? {})}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotStartedSpeaking, () => {
    addEvent({
      event: clientJs.RTVIEvent.BotStartedSpeaking,
      message: "Bot started speaking",
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.BotStoppedSpeaking, () => {
    addEvent({
      event: clientJs.RTVIEvent.BotStoppedSpeaking,
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.Connected, () => {
    addEvent({
      event: clientJs.RTVIEvent.Connected,
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.Disconnected, () => {
    addEvent({
      event: clientJs.RTVIEvent.Disconnected,
      message: "Client disconnected",
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.Error, (message) => {
    addEvent({
      event: clientJs.RTVIEvent.Error,
      message: `Error: ${JSON.stringify(message)}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.ParticipantConnected, (participant) => {
    addEvent({
      event: clientJs.RTVIEvent.ParticipantConnected,
      message: `Participant connected: ${participant.id}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.ParticipantLeft, (participant) => {
    addEvent({
      event: clientJs.RTVIEvent.ParticipantLeft,
      message: `Participant left: ${participant.id}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.ServerMessage, (data) => {
    addEvent({
      event: clientJs.RTVIEvent.ServerMessage,
      message: `Server message: ${JSON.stringify(data)}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.TrackStarted, (track, participant) => {
    addEvent({
      event: clientJs.RTVIEvent.TrackStarted,
      message: `Track started: ${track.kind} for participant ${participant == null ? void 0 : participant.id}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.TrackStopped, (track, participant) => {
    addEvent({
      event: clientJs.RTVIEvent.TrackStopped,
      message: `Track stopped: ${track.kind} for participant ${participant == null ? void 0 : participant.id}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.ScreenTrackStarted, (track, participant) => {
    addEvent({
      event: clientJs.RTVIEvent.ScreenTrackStarted,
      message: `Screen track started: ${track.kind} for participant ${participant == null ? void 0 : participant.id}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.ScreenTrackStopped, (track, participant) => {
    addEvent({
      event: clientJs.RTVIEvent.ScreenTrackStopped,
      message: `Screen track stopped: ${track.kind} for participant ${participant == null ? void 0 : participant.id}`,
      time: (/* @__PURE__ */ new Date()).toLocaleTimeString()
    });
  });
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.UserStartedSpeaking, () => {
    addEvent({
      event: clientJs.RTVIEvent.UserStartedSpeaking,
  ...
  clientReact.useRTVIClientEvent(clientJs.RTVIEvent.UserStoppedSpeaking, () => {
    addEvent({
      event: clientJs.RTVIEvent.UserStoppedSpeaking,
    ...
    Panel$1,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          PanelHeader,
          {
            className: Metrics.cn("vkui:gap-4 vkui:justify-start vkui:items-center", {
              "vkui:py-2!": collapsed
            }),
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(PanelTitle, { children: "Events" }),
              !collapsed && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:relative", children: [
                /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:absolute vkui:inset-y-0 vkui:left-0 vkui:flex vkui:items-center vkui:pl-2 vkui:pointer-events-none", children: /* @__PURE__ */ jsxRuntime.jsx(FunnelIcon, { size: 16 }) }),
                /* @__PURE__ */ jsxRuntime.jsx(
                  Input,
                  {
                    type: "text",
        ...
        !collapsed && /* @__PURE__ */ jsxRuntime.jsx(PanelContent, { ref: scrollRef, className: "vkui:overflow-y-auto", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:grid vkui:grid-cols-[min-content_min-content_1fr] vkui:gap-x-4 vkui:gap-y-2 vkui:items-center vkui:font-mono vkui:text-xs", children: filteredEvents.map((eventData, index2) => /* @__PURE__ */ jsxRuntime.jsxs(React.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:text-xs vkui:text-muted-foreground vkui:text-nowrap", children: eventData.time }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:font-semibold", children: eventData.event }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { children: eventData.message })
        ] }, index2)) }) })
      ]
    }
  );
...
const InfoPanel = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Panel$1, { className: "vkui:h-full vkui:overflow-y-auto vkui:overflow-x-hidden", children: [
    !noStatusInfo && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(PanelHeader, { variant: "inline", children: /* @__PURE__ */ jsxRuntime.jsx(PanelTitle, { children: "Status" }) }),
      /* @__PURE__ */ jsxRuntime.jsx(PanelContent, { children: /* @__PURE__ */ jsxRuntime.jsx(ClientStatus, {}) })
    ] }),
    !noDevices && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        PanelHeader,
        {
          className: "vkui:border-t vkui:border-t-border",
          variant: "inline",
          children: /* @__PURE__ */ jsxRuntime.jsx(PanelTitle, { children: "Devices" })
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsxs(PanelContent, { children: [
        !noUserAudio && /* @__PURE__ */ jsxRuntime.jsx(UserAudioControl, {}),
        !noUserVideo && /* @__PURE__ */ jsxRuntime.jsx(UserVideoControl, {}),
        !noAudioOutput && /* @__PURE__ */ jsxRuntime.jsx(AudioOutput, {})
      ] })
    ] }),
    !noSessionInfo && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(
        PanelHeader,
        {
          className: "vkui:border-t vkui:border-t-border",
          variant: "inline",
          children: /* @__PURE__ */ jsxRuntime.jsx(PanelTitle, { children: "Session" })
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx(PanelContent, { children: /* @__PURE__ */ jsxRuntime.jsx(SessionInfo, { sessionId, participantId }) })
    ] })
  ] });
};
...
const ConsoleTemplate = ({
  ...
  const [isBotAreaCollapsed, setIsBotAreaCollapsed] = React.useState(false);
  const [isInfoPanelCollapsed, setIsInfoPanelCollapsed] = React.useState(false);
  const [isEventsPanelCollapsed, setIsEventsPanelCollapsed] = React.useState(false);
  ...
  if (!isClientReady || !client) {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex items-center justify-center h-full w-full", children: /* @__PURE__ */ jsxRuntime.jsx("div", { children: "Loading..." }) });
  }
  const noBotArea = noBotAudio && noBotVideo;
  const noConversationPanel = noConversation && noMetrics;
  const noDevices = noAudioOutput && noUserAudio && noUserVideo;
  const noInfoPanel = noStatusInfo && noDevices && noSessionInfo;
  return /* @__PURE__ */ jsxRuntime.jsx(clientReact.PipecatClientProvider, { client, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:grid vkui:grid-cols-1 vkui:grid-rows-[min-content_1fr] vkui:sm:grid-rows-[min-content_1fr_auto] vkui:h-full vkui:w-full vkui:overflow-auto", children: [
    /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:grid vkui:grid-cols-2 vkui:sm:grid-cols-[150px_1fr_150px] vkui:gap-2 vkui:items-center vkui:justify-center vkui:p-2 vkui:bg-background vkui:sm:relative vkui:top-0 vkui:w-full vkui:z-10", children: [
      noLogo ? /* @__PURE__ */ jsxRuntime.jsx("span", { className: "vkui:h-6" }) : /* @__PURE__ */ jsxRuntime.jsx(
        PipecatLogo,
        {
      ...
      /* @__PURE__ */ jsxRuntime.jsx("strong", { className: "vkui:hidden vkui:sm:block vkui:text-center", children: title }),
      /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:flex vkui:items-center vkui:justify-end vkui:gap-4", children: [
        !noThemeSwitch && /* @__PURE__ */ jsxRuntime.jsx(ThemeModeToggle, {}),
        /* @__PURE__ */ jsxRuntime.jsx(
          ConnectButton,
          {
    ...
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: "vkui:hidden vkui:sm:block", children: /* @__PURE__ */ jsxRuntime.jsxs(ResizablePanelGroup, { direction: "vertical", className: "vkui:h-full", children: [
      /* @__PURE__ */ jsxRuntime.jsx(ResizablePanel, { defaultSize: 70, minSize: 50, children: /* @__PURE__ */ jsxRuntime.jsxs(ResizablePanelGroup, { direction: "horizontal", children: [
        !noBotArea && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsxs(
            ResizablePanel,
            {
              ...
              children: [
                !noBotAudio && /* @__PURE__ */ jsxRuntime.jsx(
                  BotAudioPanel,
                  {
                    className: Metrics.cn({
                ...
                !noBotVideo && /* @__PURE__ */ jsxRuntime.jsx(
                  BotVideoPanel,
                  {
                    className: Metrics.cn({
          ...
          (!noConversationPanel || !noInfoPanel) && /* @__PURE__ */ jsxRuntime.jsx(ResizableHandle, { withHandle: true })
        ] }),
        !noConversationPanel && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            ResizablePanel,
            {
          ...
          !noInfoPanel && /* @__PURE__ */ jsxRuntime.jsx(ResizableHandle, { withHandle: true })
        ] }),
        !noInfoPanel && /* @__PURE__ */ jsxRuntime.jsx(
          ResizablePanel,
          {
            id: "info-panel",
            collapsible: true,
            ...
            className: "vkui:p-2",
            children: isInfoPanelCollapsed ? /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:flex vkui:flex-col vkui:items-center vkui:justify-center vkui:gap-4 vkui:h-full", children: [
              !noStatusInfo && /* @__PURE__ */ jsxRuntime.jsxs(Popover, { children: [
                /* @__PURE__ */ jsxRuntime.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(Button, { variant: "ghost", size: "icon", children: /* @__PURE__ */ jsxRuntime.jsx(ChevronsLeftRightEllipsisIcon, { size: 16 }) }) }),
                /* @__PURE__ */ jsxRuntime.jsx(PopoverContent, { side: "left", children: /* @__PURE__ */ jsxRuntime.jsx(ClientStatus, {}) })
              ] }),
              !noDevices && /* @__PURE__ */ jsxRuntime.jsxs(Popover, { children: [
                /* @__PURE__ */ jsxRuntime.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(Button, { variant: "ghost", size: "icon", children: /* @__PURE__ */ jsxRuntime.jsx(MicIcon, { size: 16 }) }) }),
                /* @__PURE__ */ jsxRuntime.jsxs(
                  PopoverContent,
                  {
              ...
              !noSessionInfo && /* @__PURE__ */ jsxRuntime.jsxs(Popover, { children: [
                /* @__PURE__ */ jsxRuntime.jsx(PopoverTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx(Button, { variant: "ghost", size: "icon", children: /* @__PURE__ */ jsxRuntime.jsx(InfoIcon, { size: 16 }) }) }),
                /* @__PURE__ */ jsxRuntime.jsx(PopoverContent, { side: "left", children: /* @__PURE__ */ jsxRuntime.jsx(
                  SessionInfo,
                  {
                    sessionId,
                    participantId
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ResizableHandle, { withHandle: true }),
      /* @__PURE__ */ jsxRuntime.jsx(
        ResizablePanel,
        {
          collapsible: true,
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(EventsPanel, { collapsed: isEventsPanelCollapsed })
        }
      )
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(
      Tabs,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "vkui:flex vkui:flex-col vkui:overflow-hidden", children: [
            !noBotArea && /* @__PURE__ */ jsxRuntime.jsxs(
              TabsContent,
              {
                value: "bot",
                className: "vkui:flex-1 vkui:overflow-auto vkui:flex vkui:flex-col vkui:gap-4 vkui:p-2",
                children: [
                  !noBotAudio && /* @__PURE__ */ jsxRuntime.jsx(BotAudioPanel, {}),
                  !noBotVideo && /* @__PURE__ */ jsxRuntime.jsx(BotVideoPanel, {})
                ]
              }
            ),
            !noConversationPanel && /* @__PURE__ */ jsxRuntime.jsx(
              TabsContent,
              {
                value: "conversation",
            ...
            /* @__PURE__ */ jsxRuntime.jsx(
              TabsContent,
              {
                value: "events",
                className: "vkui:flex-1 vkui:overflow-auto",
                children: /* @__PURE__ */ jsxRuntime.jsx(EventsPanel, {})
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntime.jsxs(TabsList, { className: "vkui:w-full vkui:h-12 vkui:rounded-none vkui:z-10 vkui:mt-auto vkui:shrink-0", children: [
            !noBotArea && /* @__PURE__ */ jsxRuntime.jsx(TabsTrigger, { value: "bot", children: /* @__PURE__ */ jsxRuntime.jsx(BotIcon, {}) }),
            !noConversationPanel && /* @__PURE__ */ jsxRuntime.jsx(TabsTrigger, { value: "conversation", children: /* @__PURE__ */ jsxRuntime.jsx(MessagesSquareIcon, {}) }),
            /* @__PURE__ */ jsxRuntime.jsx(TabsTrigger, { value: "info", children: /* @__PURE__ */ jsxRuntime.jsx(InfoIcon, {}) }),
            /* @__PURE__ */ jsxRuntime.jsx(TabsTrigger, { value: "events", children: /* @__PURE__ */ jsxRuntime.jsx(ChevronsLeftRightEllipsisIcon, {}) })
          ] })
        ]
      }
    ),
    !noAudioOutput && /* @__PURE__ */ jsxRuntime.jsx(clientReact.PipecatClientAudio, {})
  ] }) });
};
exports.ArrowDownIcon = ArrowDownIcon;
exports.AudioClientHelper = AudioClientHelper;
...
exports.ChevronsLeftRightEllipsisIcon = ChevronsLeftRightEllipsisIcon;
exports.CircleIcon = CircleIcon;
exports.ClientStatus = ClientStatus;
exports.ConnectButton = ConnectButton;
exports.ConnectButtonComponent = ConnectButtonComponent;
exports.ConsoleTemplate = ConsoleTemplate;
exports.ControlBar = ControlBar;
exports.ControlBarDivider = ControlBarDivider;
...
exports.MessagesSquareIcon = MessagesSquareIcon;
...
exports.PhoneCallEndIcon = PhoneCallEndIcon;
exports.PhoneCallIcon = PhoneCallIcon;
exports.PipecatLogo = PipecatLogo;
...
exports.SelectChevronIcon = SelectChevronIcon;
...
exports.TranscriptOverlay = TranscriptOverlay;
exports.TranscriptOverlayComponent = TranscriptOverlayComponent;
exports.TranscriptOverlayPartComponent = TranscriptOverlayPartComponent;
exports.UserAudioComponent = UserAudioComponent;
exports.UserAudioControl = UserAudioControl;
exports.UserVideoComponent = UserVideoComponent;
exports.UserVideoControl = UserVideoControl;
exports.VideoIcon = VideoIcon;
exports.VideoOffIcon = VideoOffIcon;
exports.VoiceVisualizer = VoiceVisualizer;
