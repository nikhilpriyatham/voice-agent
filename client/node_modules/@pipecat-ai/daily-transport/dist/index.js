...
class $28bdeb35415d61e8$export$b1ca982aa1e488c1 extends (0, $jrPAn$pipecataiclientjs.Transport) {
    ...
    initialize(options, messageHandler) {
        ...
        (0, $jrPAn$pipecataiclientjs.logger).debug("[Daily Transport] Initialized", (0, (/*@__PURE__*/$parcel$interopDefault($c2e964a535c1120e$exports))).version);
    }
    get dailyCallClient() {
    ...
    async startRecording() {
        try {
            (0, $jrPAn$pipecataiclientjs.logger).info("[Daily Transport] Initializing recording");
            ...
            (0, $jrPAn$pipecataiclientjs.logger).info("[Daily Transport] Recording Initialized");
        } catch (e) {
            const err = e;
    ...
    _validateConnectionParams(connectParams) {
        ...
        if (typeof connectParams !== "object") throw new (0, $jrPAn$pipecataiclientjs.RTVIError)("Invalid connection parameters");
        ...
        return new Promise((resolve)=>{
            ...
            const readyHandler = (ev)=>{
                if (!ev.participant?.local) {
                    ...
                    if (isIOS()) {
                        (0, $jrPAn$pipecataiclientjs.logger).debug("[Daily Transport] iOS device detected, adding 0.5 second delay before sending ready message");
