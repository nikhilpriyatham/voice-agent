...
class $683f111f61e07358$export$b1ca982aa1e488c1 extends (0, $7zbD8$Transport) {
    ...
    initialize(options, messageHandler) {
        ...
        (0, $7zbD8$logger).debug("[RTVI Transport] Initialized", (0, (/*@__PURE__*/$parcel$interopDefault($58d19ff082af5e5c$exports))).version);
    }
    get dailyCallClient() {
    ...
    async startRecording() {
        try {
            (0, $7zbD8$logger).info("[RTVI Transport] Initializing recording");
            ...
            (0, $7zbD8$logger).info("[RTVI Transport] Recording Initialized");
        } catch (e) {
            const err = e;
        ...
        return new Promise((resolve)=>{
            ...
            const readyHandler = (ev)=>{
                if (!ev.participant?.local) {
                    ...
                    if (isIOS()) {
                        (0, $7zbD8$logger).debug("[RTVI Transport] iOS device detected, adding 0.5 second delay before sending ready message");
