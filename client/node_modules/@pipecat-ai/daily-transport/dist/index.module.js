...
import {logger as $7zbD8$logger, RTVIError as $7zbD8$RTVIError, TransportStartError as $7zbD8$TransportStartError, RTVIMessage as $7zbD8$RTVIMessage, Transport as $7zbD8$Transport} from "@pipecat-ai/client-js";
...
class $683f111f61e07358$export$b1ca982aa1e488c1 extends (0, $7zbD8$Transport) {
    constructor(opts = {}){
        super();
        this._botId = "";
        this._selectedCam = {};
        ...
        this._daily = (0, $7zbD8$dailycodailyjs).createCallObject({
    ...
    flushAudioQueue() {
        ...
        (0, $7zbD8$logger).debug(`Will flush audio queue: ${this._audioQueue.length}`);
    ...
    initialize(options, messageHandler) {
        ...
        (0, $7zbD8$logger).debug("[Daily Transport] Initialized", (0, (/*@__PURE__*/$parcel$interopDefault($58d19ff082af5e5c$exports))).version);
    }
    get dailyCallClient() {
    ...
    async startRecording() {
        try {
            (0, $7zbD8$logger).info("[Daily Transport] Initializing recording");
            ...
            (0, $7zbD8$logger).info("[Daily Transport] Recording Initialized");
        } catch (e) {
            const err = e;
            if (!err.message.includes("Already recording")) (0, $7zbD8$logger).error("Error starting recording", e);
        }
    }
    ...
    async initDevices() {
        if (!this._daily) throw new (0, $7zbD8$RTVIError)("Transport instance not initialized");
    ...
    _validateConnectionParams(connectParams) {
        ...
        if (typeof connectParams !== "object") throw new (0, $7zbD8$RTVIError)("Invalid connection parameters");
    ...
    async _connect(connectParams) {
        ...
        try {
            ...
            (0, $7zbD8$logger).error("Failed to join room", e);
            this.state = "error";
            throw new (0, $7zbD8$TransportStartError)();
        }
    ...
    async sendReadyMessage() {
        return new Promise((resolve)=>{
            ...
            const sendReadyMessage = ()=>{
                ...
                this.sendMessage((0, $7zbD8$RTVIMessage).clientReady());
                this.stopRecording();
                resolve();
            };
            ...
            const readyHandler = (ev)=>{
                if (!ev.participant?.local) {
                    ...
                    if (isIOS()) {
                        (0, $7zbD8$logger).debug("[Daily Transport] iOS device detected, adding 0.5 second delay before sending ready message");
        ...
        switch(status){
            ...
            default:
                if (this._currentAudioTrack !== track) {
                    ...
                    await this._mediaStreamRecorder.begin(track);
                    await this.startRecording();
                } else (0, $7zbD8$logger).warn("track-started event received for current track and already recording");
                break;
        }
    ...
    handleFatalError(ev) {
        (0, $7zbD8$logger).error("Daily fatal error", ev.errorMsg);
        this.state = "error";
        this._botId = "";
        this._callbacks.onError?.((0, $7zbD8$RTVIMessage).error(ev.errorMsg, true));
    }
...
export {$683f111f61e07358$export$ef180de88fd317cc as DailyRTVIMessageType, $683f111f61e07358$export$b1ca982aa1e488c1 as DailyTransport};
