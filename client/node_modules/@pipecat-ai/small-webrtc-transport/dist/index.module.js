import {logger as $99wTV$logger, RTVIError as $99wTV$RTVIError, TransportStartError as $99wTV$TransportStartError, RTVIMessage as $99wTV$RTVIMessage, Transport as $99wTV$Transport} from "@pipecat-ai/client-js";
...
class $b31644dc78dca54a$export$62043589d053a879 extends (0, $99wTV$Transport) {
    ...
    _validateConnectionParams(connectParams) {
        ...
        if (typeof connectParams !== "object") throw new (0, $99wTV$RTVIError)("Invalid connection parameters");
        for (const [key, val] of Object.entries(connectParams)){
            if (key !== "connectionUrl") throw new (0, $99wTV$RTVIError)(`Unrecognized connection parameter: ${key}. Only 'connectionUrl' is allowed.`);
            else if (typeof val !== "string") throw new (0, $99wTV$RTVIError)(`Invalid type for connectionUrl: expected string, got ${typeof val}`);
        }
    ...
    async _connect(connectParams) {
        ...
        if (!this._connectionUrl) {
            (0, $99wTV$logger).error("No url provided for connection");
            this.state = "error";
    ...
    createPeerConnection() {
        ...
        pc.addEventListener("icegatheringstatechange", ()=>{
            (0, $99wTV$logger).debug(`iceGatheringState: ${this.pc.iceGatheringState}`);
        });
        (0, $99wTV$logger).debug(`iceGatheringState: ${pc.iceGatheringState}`);
        ...
        pc.addEventListener("track", (evt)=>{
            (0, $99wTV$logger).debug(`Received new track ${evt.track.kind}`);
    ...
    async negotiate(recreatePeerConnection = false) {
        ...
        try {
            ...
            (0, $99wTV$logger).debug(`Remote candidate supports trickle ice: ${this.pc.canTrickleIceCandidates}`);
        } catch (e) {
    ...
    enableScreenShare(enable) {
        (0, $99wTV$logger).error("startScreenShare not implemented for SmallWebRTCTransport");
        throw new Error("Not implemented");
    }
    get isSharingScreen() {
        (0, $99wTV$logger).error("isSharingScreen not implemented for SmallWebRTCTransport");
        return false;
    }
...
export {$b31644dc78dca54a$export$62043589d053a879 as SmallWebRTCTransport};
